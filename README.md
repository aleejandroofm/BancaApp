...
4. En *Select root directory*, busca la carpeta del proyecto clonado.
5. Asegúrate de que el proyecto esté marcado y haz clic en **Finish**.

### 3. Configuración de la Base de Datos

* Ejecuta el script `script.sql` incluido en la raíz del proyecto dentro de tu gestor de MySQL para crear el esquema y las tablas necesarias.
...
1. Localiza la clase principal `Main` dentro del paquete ejecutable (`App`).
2. Haz clic derecho sobre el archivo -> **Run As > Java Application**.
...
| Rol | Nombre |
| :--- | :--- |
| **Product Owner / Scrum Master** | Alejandro Ferrándiz Martínez |
